        ...
        for label, file_path in file_paths:
            try:
                ...
                if file_path.endswith(self.config.isotopologues + ".csv"):
                    ...
                    logger.critical("File %s not found, continuing", file_path)
                dfs.append(None)
...
class DataIntegration(Dataset):
    ...
    def set_dataset_integration_config(self):
        ...
        #self.save_datafiles_split_by_compartment() # TODO: delete this and all related to 'processed' intermediary folder
